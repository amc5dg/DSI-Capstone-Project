...
galaxy_types = ['face_on_spiral', 'merger']
...
def save_outputs(X_train, X_test, y_train, y_test, extension):
    '''
    input: X_train, X_test, y_train, y_test (np arrays), extension (str)
...
if __name__ == '__main__':
    ...
    save_outputs(X_train, X_test, y_train, y_test, 'expert_small')
